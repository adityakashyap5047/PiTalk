  ...
  return (
    <div className="max-w-screen-xl mt-10 lg:mt-10 px-4 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:grid lg:grid-cols-12 min-h-[calc(100vh-64px)]">
      ...
      <div className="space-y-4 sm:flex sm:space-y-0 sm:space-x-4 justify-center lg:col-span-12 mt-8 lg:mt-0 lg:hidden">
        {/* View on GitHub Button */}
        <Link href="https://github.com/adityakashyap5047/PiTalk" target="_blank" className="inline-flex cursor-pointer items-center justify-center w-full px-5 py-3 text-sm font-medium text-center text-gray-900 border border-gray-200 rounded-lg sm:w-auto hover:bg-gray-100 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
          View on Github
        </Link>
