  ...
  return (
    <div className="bg-gradient-linear from-[#343eb4] via-purple-500 to-[#343eb4] bg-[length:200%_200%] animate-bg-gradient transition-colors dark:from-[#121212] dark:via-[#080F58] dark:to-[#121212] text-gray-800 py-10 px-4">
      <div className="container mx-auto max-w-4xl shadow-md rounded-md p-6">
        <h1 className="text-3xl font-bold text-[#8ec0e8] dark:text-[#2fdab2] mb-6">Privacy Policy</h1>
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Information We Collect</h2>
        <p className="mb-4 text-[#33b2e0] dark:text-[#c5b8e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">How We Use Your Information</h2>
        <p className="mb-4 text-[#33b2e0] dark:text-[#c5b8e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Sharing Your Information</h2>
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Cookies</h2>
        <p className="mb-4 text-[#8ec0e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Your Rights</h2>
        <p className="mb-4 text-[#8ec0e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Changes to This Policy</h2>
        <p className="mb-4 text-[#8ec0e8]">
