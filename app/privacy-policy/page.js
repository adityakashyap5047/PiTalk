  ...
  return (
    <div className="bg-gradient-linear from-[#080F58] via-purple-500 to-[#080F58] bg-[length:200%_200%] animate-bg-gradient text-gray-800 py-10 px-4">
      <div className="container mx-auto max-w-4xl shadow-md rounded-md p-6">
        ...
        <h2 className="text-2xl font-semibold text-[#8ec0e8] mb-4">Information We Collect</h2>
        <p className="mb-4 text-gray-700">
        ...
        <h2 className="text-2xl font-semibold text-[#8ec0e8] mb-4">How We Use Your Information</h2>
        <p className="mb-4 text-gray-700">
        ...
        <h2 className="text-2xl font-semibold text-[#8ec0e8] mb-4">Sharing Your Information</h2>
        <p className="mb-4 text-gray-700">
        ...
        <h2 className="text-2xl font-semibold text-[#8ec0e8] mb-4">Cookies</h2>
        <p className="mb-4 text-gray-700">
        ...
        <h2 className="text-2xl font-semibold text-[#8ec0e8] mb-4">Your Rights</h2>
        <p className="mb-4 text-gray-700">
        ...
        <h2 className="text-2xl font-semibold text-[#8ec0e8] mb-4">Changes to This Policy</h2>
        <p className="mb-4 text-gray-700">
