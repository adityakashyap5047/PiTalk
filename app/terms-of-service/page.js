...
const TermsOfService = () => {
  return (
    <div className="bg-gradient-linear from-[#080F58] via-purple-500 to-[#080F58] bg-[length:200%_200%] animate-bg-gradient text-gray-800 dark:from-[#121212] dark:via-[#080F58] dark:to-[#121212] py-10 px-4">
      <div className="container mx-auto max-w-4xl shadow-md rounded-md p-6">
        <h1 className="text-3xl font-bold text-[#8ec0e8] dark:text-[#2fdab2] mb-6">Terms of Service</h1>
        <p className="mb-4 text-[#33b2e0] dark:text-[#c5b8e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Acceptance of Terms</h2>
        <p className="mb-4 text-[#8ec0e8] dark:text-[#8ec0e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">User Responsibilities</h2>
        <p className="mb-4 text-[#33b2e0] dark:text-[#c5b8e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Prohibited Activities</h2>
        <p className="mb-4 text-[#33b2e0] dark:text-[#c5b8e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Intellectual Property</h2>
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Limitation of Liability</h2>
        <p className="mb-4 text-[#8ec0e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Termination</h2>
        <p className="mb-4 text-[#8ec0e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Changes to the Terms</h2>
        <p className="mb-4 text-[#8ec0e8]">
        ...
        <h2 className="text-2xl font-semibold text-[#2fdab2] dark:text-[#4441d5] mb-4">Contact Us</h2>
